...
import {AppScope, AppScopeForm, createScopeId} from '@libs/sdk/scope';
...
export class UserEditScopeFormComponent implements OnInit {
    @ViewChild('entitySelect') entitySelectRef: CustomSelectComponent<AppEntity> | undefined;
    ...
    form: FormGroup<ControlsOf<AppScopeForm>>;

    private activeOperation: Observable<AppScope> | undefined;

    constructor(
        private fb: FormBuilder,
        private ref: MatDialogRef<Partial<AppScopeForm>>,
        private crudService: CrudImplService<AppScope, string>,
        private notification: NotificationService,
        private mapper: FormMapper<AppScope, AppScopeForm>,
        @Inject(MAT_DIALOG_DATA) private data: Partial<AppScopeForm>,
    ...
    async submitForm() {
        ...
        try {
            ...
            const raw = { ...this.form.getRawValue() } as AppScope;
    ...
    private buildForm() {
        return this.fb.group<ControlsOf<AppScopeForm>>({
