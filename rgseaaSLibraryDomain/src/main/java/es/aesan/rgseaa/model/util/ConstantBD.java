...
public class ConstantBD {
    ...
    public static final String TABLE_COMPANIES_SITUATIONS="COMPANIES_SITUATIONS";
    ...
    public static final String TABLE_ACTUATIONS = "ACTUATIONS";
    ...
    public static final String TABLE_RGSEAA_ACTIVITIES="RGSEAA_ACTIVITIES";
    public static final String TABLE_RGSEAA_AUTHORIZATIONS="RGSEAA_AUTHORIZATIONS";
