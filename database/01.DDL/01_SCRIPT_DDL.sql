...
CREATE SEQUENCE SEQ_TYPES_EXPEDIENTS START WITH 1 INCREMENT BY 1;
...
ALTER TABLE USERS ADD CONSTRAINT FK_USERS__TYPE_PROFILE_ID FOREIGN KEY (PROFILE_ID) REFERENCES PROFILES(ID);
...
CREATE TABLE TYPES_EXPEDIENTS
(
    ID          NUMBER(12) DEFAULT "SEQ_TYPES_EXPEDIENTS"."NEXTVAL" NOT NULL,
    CODE        VARCHAR2(3),
    NAME        VARCHAR2(200),
    CREATED_BY  NUMBER(32),
    CREATED_AT  TIMESTAMP(6),
...
ALTER TABLE TYPES_EXPEDIENTS ADD CONSTRAINT PK_TYPES_EXPEDIENTS_ID PRIMARY KEY (ID);
...
ALTER TABLE DENOMINATION_SALES ADD CONSTRAINT FK_DENOMINATION_SALES__TYPE_EXPEDIENT_ID FOREIGN KEY (TYPE_EXPEDIENT_ID) REFERENCES TYPES_EXPEDIENTS(ID);
