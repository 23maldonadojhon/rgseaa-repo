...
ALTER TABLE COMPANIES_ACTUATIONS ADD CONSTRAINT FK_COMPANIES_ACTUATIONS__ESTABLISHMENT_ID FOREIGN KEY (ESTABLISHMENT_ID) REFERENCES ESTABLISHMENTS(ID);
...
ALTER TABLE COMPANIES_ACTUATIONS ADD ESTABLISHMENT_ID NUMBER(12) NULL;
ALTER TABLE COMPANIES_ACTUATIONS MODIFY COMPANY_ID NUMBER(12) NULL;
ALTER TABLE SUBSTANCES DROP COLUMN ESTABLISHMENT_ID;
