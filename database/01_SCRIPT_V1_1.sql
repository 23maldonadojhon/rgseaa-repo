...
ALTER TABLE ACTIVITIES_KEYS_CATEGORIES_SUB_ACTIVITIES ADD CONSTRAINT FK_ACTIVITIES_KEYS_CATEGORIES_SUB_ACTIVITIES__SUB_ACTIVITY_ID           FOREIGN KEY (SUB_ACTIVITY_ID)           REFERENCES SUB_ACTIVITIES(ID);             REFERENCES USERS(ID);
