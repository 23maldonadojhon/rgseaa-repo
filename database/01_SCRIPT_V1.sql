...
CREATE SEQUENCE SEQ_RGSEAA_ACTIVITY START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_STATES START WITH 100 INCREMENT BY 1 CACHE 30;
...
CREATE TABLE ACTIVITIES_KEYS (
    ...
    SUB_CATEGORIES  SUB_CATEGORY_ARRAY,
    CREATED_BY      NUMBER(32),
    CREATED_AT      TIMESTAMP(6),
    UPDATED_BY      NUMBER(32),
    UPDATED_AT      TIMESTAMP(6),
...
NESTED TABLE CATEGORIES STORE AS CATEGORIES_TABLE
NESTED TABLE SUB_CATEGORIES STORE AS SUB_CATEGORIES_TABLE;
