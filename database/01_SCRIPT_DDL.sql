CREATE SEQUENCE SEQ_CATEGORIES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_SUB_ACTIVITIES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_ACTIVITIES START WITH 100 INCREMENT BY 1 CACHE 30;
...
CREATE SEQUENCE SEQ_KEYS START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_ACTIVITIES_KEYS START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_SITUATIONS START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_COUNTRIES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_CCAA START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_PROVINCES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_LOCATIONS START WITH 100 INCREMENT BY 1 CACHE 30;
...
CREATE SEQUENCE SEQ_USERS_MODULES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_USERS_PROFILES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_USERS_ENTITIES START WITH 100 INCREMENT BY 1 CACHE 30;
CREATE SEQUENCE SEQ_TYPES_ACTIONS START WITH 100 INCREMENT BY 1 CACHE 30;
...
/*CREATE TYPE CATEGORY_REF AS OBJECT (
    ID NUMBER(12)
);
CREATE TYPE SUB_CATEGORY_REF AS OBJECT (
    ID NUMBER(12)
);

CREATE TYPE CATEGORY_ARRAY AS TABLE OF CATEGORY_REF;
CREATE TYPE SUB_CATEGORY_ARRAY AS TABLE OF SUB_CATEGORY_REF;
*/
...
--ALTER TABLE TYPES_ACTIONS ADD CONSTRAINT FK_TYPES_ACTIONS__CREATED_BY_ID  FOREIGN KEY (CREATED_BY)    REFERENCES USERS(ID);
--ALTER TABLE TYPES_ACTIONS ADD CONSTRAINT FK_TYPES_ACTIONS__UPDATED_BY_ID  FOREIGN KEY (UPDATED_BY)    REFERENCES USERS(ID);
...
ALTER TABLE ACTIONS ADD CONSTRAINT FK_ACTIONS__TYPE_ACTION_ID   FOREIGN KEY (TYPE_ACTION_ID)    REFERENCES TYPES_ACTIONS(ID);
ALTER TABLE ACTIONS ADD CONSTRAINT FK_ACTIONS__COMPANY_ID       FOREIGN KEY (COMPANY_ID)        REFERENCES COMPANIES(ID);
--ALTER TABLE ACTIONS ADD CONSTRAINT FK_ACTIONS__CREATED_BY_ID    FOREIGN KEY (CREATED_BY)        REFERENCES USERS(ID);
--ALTER TABLE ACTIONS ADD CONSTRAINT FK_ACTIONS__UPDATED_BY_ID    FOREIGN KEY (UPDATED_BY)        REFERENCES USERS(ID);
...
(
    ...
    COMPANY_ID              NUMBER(12) NOT NULL,
    ESTABLISHMENT_ID        NUMBER(12) NOT NULL,
    KEY_ID                  NUMBER(12) NOT NULL,
...
ALTER TABLE RGSEAA_ACTIVITIES ADD CONSTRAINT FK_RGSEAA_ACTIVITIES__ACTIVITY_KEY_CATEGORY_SUB_ACTIVITY_ID    FOREIGN KEY (ACTIVITY_KEY_CATEGORY_SUB_ACTIVITY_ID)     REFERENCES ACTIVITIES_KEYS_CATEGORIES_SUB_ACTIVITIES(ID);
...
ALTER TABLE RGSEAA_FEES ADD CONSTRAINT FK_RGSEAA_FEES__FEE_ID_ID    FOREIGN KEY (FEE_ID)        REFERENCES FEES(ID);
--ALTER TABLE RGSEAA ADD CONSTRAINT FK_RGSEAA__CREATED_BY_ID    FOREIGN KEY (CREATED_BY)       REFERENCES USERS(ID);
--ALTER TABLE RGSEAA ADD CONSTRAINT FK_RGSEAA__UPDATED_BY_ID    FOREIGN KEY (UPDATED_BY)       REFERENCES USERS(ID);
...
"RGSEAA_ID", "NUM_RGSEAA", "KEY_ID", "KEY_NAME", "ACTIVITY_ID", "ACTIVITY_NAME", "CATEGORY_ID", "CATEGORY_NAME", "SUB_ACTIVITY_ID", "SUB_ACTIVITY_NAME") DEFAULT COLLATION "BINARY_AI"  AS 
  ...
  SA.ID SUB_ACTIVITY_ID,
  SA.NAME AS SUB_ACTIVITY_NAME
FROM RGSEAA R
  JOIN RGSEAA_ACTIVITIES RA ON R.ID = RA.RGSEAA_ID
